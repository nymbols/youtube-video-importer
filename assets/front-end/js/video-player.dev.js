...
;(function($){
	...
	$.fn.YYTT_VideoPlayer = function(options){
		...
		var generateIds = function(){
			var cid 	= 'YYTT_videoPlayerContainer_', // container id prefix
				pid 	= 'YYTTVideoPlayer', // player id prefix
...
function onYouTubePlayerReady( pid ){
	var playerContainer = pid.replace('YYTTVideoPlayer', '#YYTT_videoPlayerContainer_');	
	jQuery(playerContainer).data('ref').updateStatus( 1 );
	
	var player = document.getElementById( pid ),
		p = jQuery( pid.replace('YYTTVideoPlayer', '#YYTT_videoPlayerContainer_') );
	...
	YYTT_YT_PLAYERS[idPlayerParams] = {
		idPlayer: pid,
	...
	player.addEventListener ('onStateChange', 'YYTT_YT_PLAYERS.' + idPlayerParams + '.onStateChanged');
}
...
// YouTube
var YYTT_YT_API_LOADED = false;

;(function($){
	$(document).ready(function(){
		//*
		window.onYouTubePlayerAPIReady = function(){
			YYTT_YT_API_LOADED = true;
		}
		//*/
		$('div.yytt_single_video_player').YYTT_VideoPlayer({'elem_data' : true});		
	})
})(jQuery);
