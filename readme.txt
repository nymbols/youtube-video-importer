...
You can opt for bulk imports through a variety of ways. Bulk imports are now possible through the YouTube user playlists, YouTube play lists and YouTube search queries. This plug-in is a real asset for video publishers. It is up to you how you want to display the video in the blog post. If you wish not to make every element of the blog public then it is not a problem at all. You can easily set your video post to a private status so it would not display at the front-end. If you want to make your video post public then you need to select the Make video posts public option. It is up to use to use the video as short-codes as well in your blog post. Interestingly the video posts operate in WordPress just like normal blog posts so your post maybe in the pending or published status or you may save it as a draft. You need to make use of import status to set the status of bulk imported videos. Multiple options are available in this regard.
